...
function add(id,bstock)
{
   ...
   if(num<bstock)
   {
	   ...
	   hiddenSum.value=parseFloat(hiddenSum.value)+parseFloat(document.getElementById("price"+id).value);
	   sum.innerHTML=parseFloat(hiddenSum.value).toFixed(2);
	   $.post("Cart/modifyItem",{"number":num,"cid":id},function(){
...
function deleteCart(id)
{
   ...
   $.post("Cart/deleteItem",{"cid":id},function(){
