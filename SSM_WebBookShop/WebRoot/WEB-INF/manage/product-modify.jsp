...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改商品</h2>
		<div class="manage">
			<form action="productModifyAction" method="post"
			enctype="multipart/form-data">
				<input type="hidden" class="text" name="bid" value="${book.bid }" />
				<table class="form">
					<tr>
						<td class="field">商品名称：</td>
						<td><input id="banme" type="text" class="text" name="bname" value="${book.bname }" /></td>
					</tr>
					<tr>
						<td class="field">商品描述：</td>
						<td><input type="text" class="text" name="bcontent" value="${book.bcontent }" /></td>
					</tr>
					<tr>
						<td class="field">商品价格：</td>
						<td><input type="text" class="text" name="bprice" value="${book.bprice}"/> 元</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="text" name="bauthor" value="${book.bauthor}"/></td>
					</tr>
					<tr>
						<td class="field">出版社：</td>
						<td><input type="text" class="text" name="bpublisher" value="${book.bpublisher}"/></td>
					</tr>
					<tr>
						<td class="field">ISBN：</td>
						<td><input type="text" class="text" name="bisbn" value="${book.bisbn}"/></td>
					</tr>
					<tr>
					...
					<td>	<img class="field" id="picDisplay" style="wdith:200px;height:200px;margin-bottom:70px"
					...
					<tr>
						...
						<input id="bpicname" type="hidden" name="bpic" value="${book.bpic}"/>				
					<tr>
						<td class="field">库存：</td>
						<td><input type="text" class="text tiny" name="bstock" value="${book.bstock}"/></td>
					</tr>
					<tr>
						<td></td>
