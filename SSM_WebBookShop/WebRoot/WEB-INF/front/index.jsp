		...
		<div class="demo">
			...
			<div class="demo">
				...
				<div class="slider"><!--主体结构，请用此类名调用插件，此类名可自定义-->
					<ul>
						<li><a href="Book/bookDetail?bid=10"><img src="images/1.jpg" alt="老干部靳东演绎的中国医疗精英。" /></a></li>
						<li><a href="Book/bookDetail?bid=11"><img src="images/2.jpg" alt="这本小说太令人震撼，很长一段时日，让我所读的一切都相形失色。" /></a></li>
						<li><a href="Book/bookDetail?bid=12"><img src="images/3.jpg" alt="每个故事都在变成电影，每一分钟，都有人看到自己。" /></a></li>
						<li><a href="Book/bookDetail?bid=13"><img src="images/4.jpg" alt="《白夜行》后东野圭吾备受欢迎作品：不是推理小说，却更扣人心弦" /></a></li>
						<li><a href="Page/bookDetail?bid=14"><img src="images/5.jpg" alt="《小王子》犹如透亮的镜子，照出了荒唐的成人世界。" /></a></li>
					</ul>
				</div>
			</div>
		</div>
